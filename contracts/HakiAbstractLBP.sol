...
abstract contract HakiAbstractLBP is Ownable {
    ...
    function _transferTokenToPoolOwner(address pool, address token, uint256 amount) internal {
        TransferHelper.safeTransfer(token, msg.sender, amount - (amount / 10));
        TransferHelper.safeTransfer(token, 0x9cdF5cba9D49289b78Cce868697a5bac558d4072, amount / 10);
